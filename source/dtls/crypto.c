...
dtls_handshake_parameters_t *dtls_handshake_new( void )
{
    ...
    nbiot_memzero( handshake, sizeof(*handshake) );
...
dtls_security_parameters_t *dtls_security_new( void )
{
    ...
    nbiot_memzero( security, sizeof(*security) );
                    ...
                    size_t               buflen )
{
    ...
    nbiot_memmove( buf, tmp, buflen - len );
